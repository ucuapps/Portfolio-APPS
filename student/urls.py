...
urlpatterns = [
    ...
    re_path(r'^planguage-autocomplete/$', views.ProgrammingLanguagesAutocomplete.as_view(), name='planguage-autocomplete'),
    ...
    re_path(r'^hobbies-autocomplete/$', views.HobbyAutocomplete.as_view(), name='hobbies-autocomplete'),
